          ...
          <svg className='svg-laptop' viewBox="16 6 284 160" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              <linearGradient id="laptop-gradient" 
                  ...
                  // x1="0" y1="0%" 
                  // x2="0" y2="100%"
                  x1="85" y1="-2.11828e-06" x2="-12" y2="239.5"
                   >
                <stop stopColor="#d2daff" />
                <stop offset="1" stopColor="#141418" />
                {/* <stop offset=".9" stopColor="#141418" />
                <stop offset="1" stopColor="#d2daff" /> */}
              </linearGradient>
            </defs>
          </svg>
        </div> 
          ...
          <svg className='svg-tablet' viewBox="5 5 160 213" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              <linearGradient id="tablet-gradient" 
                    x1="85" y1="-2.11828e-06" x2="-12" y2="239.5"
                    // x1="85" y1="0" x2="85" y2="232" 
                    gradientUnits="userSpaceOnUse">
                <stop stop-color="#9095ad"/>
